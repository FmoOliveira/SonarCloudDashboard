...
def main():
    ...
    with st.sidebar:
        ...
        with st.form(key="controls_form", border=False):
            ...
            execute_analysis = st.form_submit_button("Load Dashboard", type="primary", use_container_width=True, icon=":material/analytics:", disabled=is_date_incomplete)
